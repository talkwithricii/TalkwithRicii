...
const contents = [
  {
    ...
    lessons: [
      {
        name: "Set up Dev c++ Embarcadero",
        url: "https://www.youtube.com/embed/M-M7m-CLqTk",
        content: {
      ...
      {
        name: "What is Data Types",
        url: "https://youtu.be/l6e3q39jtqc?si=tFs3INqECbjKH7Ae",
        content: {
      ...
      {
        name: "How to use Data Types and Variables",
        url: "https://youtu.be/FxN41mUqb1Y?si=9hTS2cO20bbQnWMF",
        content: {
          title: "Your First C++ Program",
          paragraph: "Write a simple Hello World program in C++.",
           code: "// No code for installation\n<a href='#' class='exercise-link'>Setup Exercise</a>"
      ...
      {
        name: "Common Error",
        url: "https://youtu.be/9kapK4S-aVw?si=INKwMuvToeSctawn",
        content: {
          title: "Your First C++ Program",
          paragraph: "Write a simple Hello World program in C++.",
           code: "// No code for installation\n<a href='#' class='exercise-link'>Setup Exercise</a>"
      ...
      {
        name: "Input and Output with Operators",
        url: "https://youtu.be/SCkJrh2Kj-Q?si=IYoj-D389wsKShzM",
        content: {
          title: "Your First C++ Program",
          paragraph: "Write a simple Hello World program in C++.",
           code: "// No code for installation\n<a href='#' class='exercise-link'>Setup Exercise</a>"
      ...
      {
        name: "Conditional Statement if",
        url: "https://youtu.be/0LPd8QJW-UQ?si=-RLIu0aeC8yCPC05",
        content: {
          title: "Your First C++ Program",
          paragraph: "Write a simple Hello World program in C++.",
           code: "// No code for installation\n<a href='#' class='exercise-link'>Setup Exercise</a>"
      ...
      {
        name: "Logic Gates",
        url: "https://youtu.be/EN2g9HSLJCM?si=hifYYfv3gY-7bYye",
        content: {
          title: "Your First C++ Program",
          paragraph: "Write a simple Hello World program in C++.",
           code: "// No code for installation\n<a href='#' class='exercise-link'>Setup Exercise</a>"
      ...
      {
        name: "Challenge",
        url: "https://youtu.be/R-52EwXQ5tU?si=0wfDKEkH8OOtCXCg",
        content: {
          title: "Your First C++ Program",
          paragraph: "Write a simple Hello World program in C++.",
           code: "// No code for installation\n<a href='#' class='exercise-link'>Setup Exercise</a>"
      ...
      {
        name: "Solution",
        url: "https://youtu.be/BqQXLHQVtCs?si=XOa69k5hmplU0cMT",
        content: {
          title: "Your First C++ Program",
          paragraph: "Write a simple Hello World program in C++.",
           code: "// No code for installation\n<a href='#' class='exercise-link'>Setup Exercise</a>"
      ...
      {
        name: "Challenge",
        url: "https://youtu.be/aMTKO_N29WY?si=CukH2D_C0-Oc0Vct",
        content: {
          title: "Your First C++ Program",
          paragraph: "Write a simple Hello World program in C++.",
           code: "// No code for installation\n<a href='#' class='exercise-link'>Setup Exercise</a>"
...
contents.forEach(section => {
  ...
  section.lessons.forEach(lesson => {
    ...
    link.addEventListener("click", e => {
      ...
      // Removed scrollIntoView to prevent page movement
